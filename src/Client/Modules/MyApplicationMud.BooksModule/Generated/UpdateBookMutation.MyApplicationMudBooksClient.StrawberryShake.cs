...
namespace MyApplicationMud.BooksModule.GraphQL
{
    ...
    public partial class UpdateBookMutation : global::MyApplicationMud.BooksModule.GraphQL.IUpdateBookMutation
    {
        ...
        public async global::System.Threading.Tasks.Task<global::StrawberryShake.IOperationResult<IUpdateBookResult>> ExecuteAsync(global::System.String id, global::MyApplicationMud.BooksModule.GraphQL.BookModelInput book, global::System.Threading.CancellationToken cancellationToken = default)
        {
            var request = CreateRequest(id, book);
            return await _operationExecutor.ExecuteAsync(request, cancellationToken).ConfigureAwait(false);
        }

        public global::System.IObservable<global::StrawberryShake.IOperationResult<IUpdateBookResult>> Watch(global::System.String id, global::MyApplicationMud.BooksModule.GraphQL.BookModelInput book, global::StrawberryShake.ExecutionStrategy? strategy = null)
        {
            var request = CreateRequest(id, book);
            return _operationExecutor.Watch(request, strategy);
        }

        private global::StrawberryShake.OperationRequest CreateRequest(global::System.String id, global::MyApplicationMud.BooksModule.GraphQL.BookModelInput book)
        {
        ...
        private global::System.Object? FormatBook(global::MyApplicationMud.BooksModule.GraphQL.BookModelInput value)
        {
            if (value is null)
            {
                throw new global::System.ArgumentNullException(nameof(value));

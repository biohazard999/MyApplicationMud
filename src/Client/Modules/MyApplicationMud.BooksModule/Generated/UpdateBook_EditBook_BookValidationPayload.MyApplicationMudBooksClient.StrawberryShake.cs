...
namespace MyApplicationMud.BooksModule.GraphQL
{
    ...
    {
        public UpdateBook_EditBook_BookValidationPayload(global::System.Collections.Generic.IReadOnlyList<global::MyApplicationMud.BooksModule.GraphQL.IUpdateBook_EditBook_Errors> errors, global::MyApplicationMud.BooksModule.GraphQL.IUpdateBook_EditBook_Value? @value)
        {
            Errors = errors;
            Value = @value;
        }

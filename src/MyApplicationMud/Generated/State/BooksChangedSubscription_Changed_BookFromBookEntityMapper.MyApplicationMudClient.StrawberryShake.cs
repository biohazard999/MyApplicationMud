...
namespace MyApplicationMud.GraphQL.State
{
    ...
    public partial class BooksChangedSubscription_Changed_BookFromBookEntityMapper : global::StrawberryShake.IEntityMapper<global::MyApplicationMud.GraphQL.State.BookEntity, BooksChangedSubscription_Changed_Book>
    {
        ...
        public BooksChangedSubscription_Changed_BookFromBookEntityMapper(global::StrawberryShake.IEntityStore entityStore, global::StrawberryShake.IEntityMapper<global::MyApplicationMud.GraphQL.State.AuthorEntity, GetBooksListView_Items_Author_Author> getBooksListView_Items_Author_AuthorFromAuthorEntityMapper)
        {
        ...
        public BooksChangedSubscription_Changed_Book Map(global::MyApplicationMud.GraphQL.State.BookEntity entity, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            if (snapshot is null)
            {
            ...
            return new BooksChangedSubscription_Changed_Book(entity.Id, entity.Title, entity.Image, MapNonNullableIGetBooksListView_Items_Author(entity.Author, snapshot));
        }

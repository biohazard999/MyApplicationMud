...
namespace MyApplicationMud.GraphQL.State
{
    ...
    public partial class BooksAddedSubscription_Added_BookFromBookEntityMapper : global::StrawberryShake.IEntityMapper<global::MyApplicationMud.GraphQL.State.BookEntity, BooksAddedSubscription_Added_Book>
    {
        ...
        public BooksAddedSubscription_Added_BookFromBookEntityMapper(global::StrawberryShake.IEntityStore entityStore, global::StrawberryShake.IEntityMapper<global::MyApplicationMud.GraphQL.State.AuthorEntity, GetBooksListView_Items_Author_Author> getBooksListView_Items_Author_AuthorFromAuthorEntityMapper)
        {
        ...
        public BooksAddedSubscription_Added_Book Map(global::MyApplicationMud.GraphQL.State.BookEntity entity, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            if (snapshot is null)
            {
            ...
            return new BooksAddedSubscription_Added_Book(entity.Id, entity.Title, entity.Image, MapNonNullableIGetBooksListView_Items_Author(entity.Author, snapshot));
        }
